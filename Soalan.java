...
public class Soalan implements Serializable {
    private final String question, option1, option2, option3, option4;
    private final int answer;
    private int userSelectedAnswer;

    public Soalan(String question, String option1, String option2, String option3, String option4, int answer) {
